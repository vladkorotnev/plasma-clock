...
/// @brief A wave generator callback. Due to resource constraints you are expected to mix with the buffer, not overwrite it.
...
private:
    static const size_t SAMPLE_RATE = 22050;
    static const i2s_port_t I2S_NUM = I2S_NUM_0;
    static const size_t DMA_BUF_LEN = RENDER_CHUNK_SIZE;
    static const size_t DMA_NUM_BUF = 3;
    static bool i2sInited;
    static TaskHandle_t hTask;
    static void task(void*);
    static WaveGeneratorCallback callback[CHANNEL_COUNT];
};
